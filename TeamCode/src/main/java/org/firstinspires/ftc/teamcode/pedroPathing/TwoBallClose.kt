...
@Autonomous
@Configurable
class TwoBallClose: NextFTCOpMode() {
    init {
        addComponents(
    ...
    public override fun onStartButtonPressed() {
        SequentialGroup(
            ...
            InstantCommand{ Outtake.velocityTrue=true;Outtake.targetVelo = 835.0; Outtake.hP = 0.81; Outtake.hS.position = 0.81},
            Delay(1.0.seconds), // First Ball Delay
            Intake.runIntake,
            Delay(0.2.seconds),
            Intake.stopIntake,
            Delay(1.0.seconds), // Second Ball Delay
            Intake.runIntake,
            Delay(0.2.seconds),
            Intake.stopIntake,
            Outtake.flywheelOff,
