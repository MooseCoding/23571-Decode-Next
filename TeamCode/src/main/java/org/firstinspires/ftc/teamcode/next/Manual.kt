...
@TeleOp
class Manual: NextFTCOpMode() {
    init {
        addComponents(
            PedroComponent(Constants::createFollower),
            SubsystemComponent(Intake, Outtake, DriveTrain, Spindexer, Transfer, Sensor),
            BulkReadComponent,
            BindingsComponent,
        )
    }
    ...
    override fun onStartButtonPressed() {
        Gamepads.gamepad1.a whenBecomesTrue Flywheels.spin // Spin up the flywheels
